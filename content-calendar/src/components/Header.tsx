...
const TITLES: Record<View, { title: string; subtitle: string }> = {
  ...
  board: { title: 'Library', subtitle: 'Track each post from idea to published' },
  calendar: { title: 'Library', subtitle: 'See what’s scheduled, and when' },
  list: { title: 'Library', subtitle: 'Every post in one sortable, filterable table' },
  ...
  review: { title: 'Review Queue', subtitle: 'Drafts waiting for a human look — claims, citations and safety flags' },
  content: { title: 'Library', subtitle: 'One idea, several versions — review and publish each' },
  campaigns: { title: 'Campaigns', subtitle: 'Group related posts into a series and track it' },
  ideas: { title: 'Idea Lab', subtitle: 'Turn one source into five audience-specific ideas' },
  voices: { title: 'Voice Profiles', subtitle: 'Reusable writing voices for your drafts — stays on this computer' },
